...
func NewCombinedLogger(level logrus.Level, loggers ...Logger) *CombinedLogger {
...
func (c *CombinedLogger) log(level logrus.Level, logFunc func(Logger)) {
	c.m.Lock()
	defer c.m.Unlock()
...
func (c *CombinedLogger) Debug(args ...interface{}) {
	c.log(logrus.DebugLevel, func(logger Logger) {
		logger.Debug(args...)
	})
}
...
func (c *CombinedLogger) Info(args ...interface{}) {
	c.log(logrus.InfoLevel, func(logger Logger) {
		logger.Info(args...)
	})
}
...
func (c *CombinedLogger) Warn(args ...interface{}) {
	c.log(logrus.WarnLevel, func(logger Logger) {
		logger.Warn(args...)
	})
}
...
func (c *CombinedLogger) Error(args ...interface{}) {
	c.log(logrus.ErrorLevel, func(logger Logger) {
		logger.Error(args...)
	})
}
...
func (c *CombinedLogger) Fatal(args ...interface{}) {
	c.log(logrus.FatalLevel, func(logger Logger) {
		logger.Fatal(args...)
	})
}
...
func (c *CombinedLogger) Print(level logrus.Level, args ...interface{}) {
	c.log(level, func(logger Logger) {
...
func (c *CombinedLogger) ErrorStreamOnly() Logger {
	return nil
}
